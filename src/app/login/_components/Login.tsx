...
const LoginPage = () => {
  ...
  return (
    <Fragment>
      <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-black dark:border-t dark:border-gray-200">
        <div className="bg-white p-6 rounded shadow-md w-96 dark:bg-gray-300 dark:border-2 dark:border-gray-300">
          ...
          <Button
            variant="ghost"
            className="w-full bg-black text-center items-center hover:bg-black text-white mt-2 hover:text-white"
            type="button"
