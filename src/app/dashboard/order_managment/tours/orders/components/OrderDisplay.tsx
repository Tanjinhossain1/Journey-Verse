...
export default function OrderDisplay({ data = [] }: { data: TourOrderType[] }) {
  const [sortColumn, setSortColumn] = useState<keyof TourOrderType>("id");
  ...
  const handleSort = (column: keyof TourOrderType) => {
        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-black border dark:border-gray-200 bg-black dark:text-gray-300 text-white">
              ...
              <TableHead className="border-r">Tour</TableHead>
              ...
              <TableHead className="border-r">Tour Date</TableHead>
          ...
          <TableBody className="dark:text-gray-300 border-b dark:border-gray-200 ">
            {paginatedData.map((item) => (
              <TableRow className="border-b dark:border-gray-200" key={item.id}>
                ...
                <TableCell className="border-r">{item.tour_name}</TableCell>
