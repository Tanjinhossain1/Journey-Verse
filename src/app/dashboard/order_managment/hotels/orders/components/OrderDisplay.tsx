...
export default function OrderDisplay({ data = [] }: { data: OrderType[] }) {
  ...
  const handleStatusUpdate = async (data: OrderType) => {
...
//                 </TableCell>
//                 <TableCell className="border-r">
//                   <Button  className="bg-black text-white hover:bg-black  rounded-xl dark:bg-gray-300 dark:text-black" variant="secondary">
//                     Update
//                   </Button>
//                 </TableCell>
//               </TableRow>
