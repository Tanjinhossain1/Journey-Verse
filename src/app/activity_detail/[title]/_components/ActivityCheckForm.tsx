...
export default function ActivityChecker({
  ...
  const basePrice = +activity_detail.price * 1.06;
    ...
    <Card className="w-[320px] border border-gray-400 rounded-xl dark:text-gray-300">
      <CardContent className="p-6">
        ...
        <div className="pt-4">
          ...
          {bookingStatus ? (
            <p className="text-red-400">This Activity Already Booked By You</p>
          ) : null}
          {user?.email ? null : (
          ...
          <Link
            href={`/checkout/activity/${formatForUrlWith_under_score(
