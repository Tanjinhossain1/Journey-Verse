  ...
  return (
    <Fragment>
      <div className="md:flex justify-center max-w-[1200px] m-5 md:mx-auto my-20 gap-4">
        <div className="relative md:w-[600px] h-[300px] overflow-hidden rounded-2xl mb-5 md:mb-0">
          <Image
            alt="50-off image"
            layout="fill" 
            src="/50-off.jpeg"
        ...
        <div className="relative md:w-[600px] h-[300px] overflow-hidden rounded-2xl">
          <Image
            alt="20-off image"
            layout="fill" 
            src="/20-off.jpeg"
